...
- Expanded MIDI compatibility for common non-standard exports that resume
  channel running status after Meta and SysEx events when the preceding channel
  status remains valid; affected caches regenerate under the new pipeline identity.
