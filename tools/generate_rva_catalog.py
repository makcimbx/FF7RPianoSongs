...
def render_build_identity(build: dict, catalog_sha256: str, generator_sha256: str) -> bytes:
    lines = [
        "// Generated by tools/generate_rva_catalog.py from src/game/rva_catalog.json. Do not edit.",
        ...
        f"inline constexpr std::string_view kRvaCatalogSha256 = \"{catalog_sha256}\";",
        f"inline constexpr std::string_view kRvaGeneratorSha256 = \"{generator_sha256}\";",
        "", "} // namespace ff7r::piano::core::generated", "",
    ]
    return "\n".join(lines).encode("ascii")
