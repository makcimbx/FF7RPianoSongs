...
Include the FF7RPianoSongs version, executable catalog identity, affected safety
boundary, and the smallest reproducible description. Reports involving native
...
The project intentionally fails closed on unsupported executable identity,
