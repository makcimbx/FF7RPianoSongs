...
Focused Development sessions qualify both boundaries of this count-driven path on verified game build 1.005. Session `20260902T175102Z-a761305b6d59` qualified 513 rows at checkpoint `88f1f99`. Session `20260902T202554Z-ba1ee1e9374f` qualified 8192 rows at checkpoint `827a7c8`: reserve changed once from 512 to 8192 with capacity 8192, all 512 prefix and 7680 tail events validated, count-last committed 8192, native result counters totaled 8192, natural completion succeeded, and a subsequent ordinary 481-event song restored normal chart/audio behavior. Both sessions were accepted with Development `Keep`. This endpoint evidence qualifies the shared restricted 513–8192 mechanism, but not another event shape, a count above 8192, another executable build, or a packaged release artifact.
