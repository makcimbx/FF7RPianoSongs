...
Generated charts preserve source onset identity. MIDI offset, alignment, and minimum lead-in participate in chart/audio alignment and cache identity. Optional metronome guide synthesis changes generated audio only; it does not change chart timestamps, selected difficulty, or source duration.
